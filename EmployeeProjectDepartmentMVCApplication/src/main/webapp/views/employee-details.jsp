...
<body>
	...
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					...
					<td><%=projectTeamSize%>(<a
						href="/projects/<%=project.getId()%>/employees">view all</a>)</td>
				</tr>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					...
					<td><%=totalEmployees%>(<a
						href="/departments/<%=department.getId()%>/employees">view
							all</a>)</td>
				</tr>
			</tbody>
		</table>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<p style="text-align: right;"><a href="/employees/delete/<%=employee.getId()%>"
					class="btn btn-danger" role="button">Delete Employee</a></p>
			</div>
		</div>
